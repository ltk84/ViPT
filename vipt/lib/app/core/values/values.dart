...
class FakeData {
  static List<WorkoutCategory> data = [
    WorkoutCategory(null,
        name: 'Pull', asset: 'asset', parentCategoryID: 'X5ahQ5BUMYgSopogjHNO'),
    WorkoutCategory(null,
        name: 'Push', asset: 'asset', parentCategoryID: 'X5ahQ5BUMYgSopogjHNO'),
    WorkoutCategory(null,
        name: 'Shoulder',
        asset: 'asset',
        parentCategoryID: 'X5ahQ5BUMYgSopogjHNO'),
    WorkoutCategory(null,
        name: 'Biceps',
        asset: 'asset',
        parentCategoryID: 'X5ahQ5BUMYgSopogjHNO'),
    ...
    WorkoutCategory(null,
        ...
        parentCategoryID: 'X5ahQ5BUMYgSopogjHNO'),
    WorkoutCategory(null,
        name: 'Back', asset: 'asset', parentCategoryID: 'X5ahQ5BUMYgSopogjHNO'),
    WorkoutCategory(null,
        name: 'Chest',
        asset: 'asset',
        parentCategoryID: 'X5ahQ5BUMYgSopogjHNO'),
    WorkoutCategory(null,
        name: 'Abs', asset: 'asset', parentCategoryID: 'X5ahQ5BUMYgSopogjHNO'),
    WorkoutCategory(null,
        name: 'Thigh',
        asset: 'asset',
        parentCategoryID: 'X5ahQ5BUMYgSopogjHNO'),
